"""
Process MRIcroGL colormaps with luminance correction.

This script:
1. Reads all .clut colormap files from MRIcroGL Resources/lut directory
2. Applies map_luminance correction
3. Saves corrected versions to MRIcroGL folder
...
def process_mricrogl_colormaps(input_dir: str, output_dir: str):
    """
    Apply map_luminance correction to all MRIcroGL colormaps.
    
    Parameters
    ----------
    input_dir : str
        Directory containing MRIcroGL .clut files
    output_dir : str
...
def plot_comparison(before_dir: str, after_dir: str, 
                   output_file: str = 'mricrogl_colormaps_comparison.png',
                   max_plots: int = None):
    """
    Plot before/after comparison of MRIcroGL colormaps.
    ...
    # Get all .clut files from the output directory (MRIcroGL uses .clut format)
...
def main():
    ...
    print("="*60)
    print("Processing MRIcroGL Colormaps")
    print("="*60)
    
    # Define directories
    input_dir = '/users/cyrilpernet/bin/MRIcroGL/Resources/lut'
    output_dir = '/indirect/staff/cyrilpernet/brain_colours/MRIcroGL'
    ...
    # Count input files (.clut files in MRIcroGL lut directory)
    ...
    process_mricrogl_colormaps(input_dir, output_dir)
    ...
    print(f"Comparison plot: mricrogl_colormaps_comparison.png")
    print()
